...
class Jurusan extends BaseController
{
	...
	{
		$data = [
			'jurusan' => $this->request->getPost('jurusan1'),
		];

		$this->ModelJurusan->insertData($data);
		session()->setFlashdata('tambah', 'Data jurusan berhasil ditambah.');
	...
	public function editData($id_jurusan)
	{
		...
		session()->setFlashdata('edit', 'Data jurusan berhasil diubah.');
		return redirect()->to(base_url('jurusan'));
	}
	...
	public function deleteData($id_jurusan)
	{
		...
		session()->setFlashdata('delete', 'Data jurusan berhasil dihapus.');
		return redirect()->to(base_url('jurusan'));
	}
}