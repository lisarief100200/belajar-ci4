...
class Baner extends BaseController
{
    ...
    public function insertData()
    {
        ...
        session()->setFlashdata('tambah', 'Data baner berhasil ditambah.');
    ...
    public function editData($id_baner)
    {
        ...
        session()->setFlashdata('edit', 'Data baner berhasil diubah.');
		return redirect()->to(base_url('baner'));
    }
    ...
    public function deleteData($id_baner)
	{
		...
		session()->setFlashdata('delete', 'Data baner berhasil dihapus.');
		return redirect()->to(base_url('baner'));
	}
}