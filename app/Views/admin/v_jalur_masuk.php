                ...
                <tbody>
                    <?php
                        ...
                        <tr>
                            ...
                            <td><?= $value['kuota'];  ?></td>
                            <td>
                                <button class="btn btn-flat btn-warning btn-xs" data-toggle="modal" data-target="#edit<?= $value['id_jalur_masuk']; ?>">
                                    <i class="fas fa-edit"></i>
                                </button>

                                <button class="btn btn-flat btn-danger btn-xs" data-toggle="modal" data-target="#delete<?= $value['id_jalur_masuk']; ?>">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="jalur_masuk" class="form-control" placeholder="Nama Jalur Masuk" required>
                </div>
                <div class="form-group">
                    <label>Kuota</label>
...
<div class="modal fade" id="edit<?= $value['id_jalur_masuk']; ?>">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <div class="form-group">
                <label>Jalur Masuk</label>
                    <input type="text" value="<?= $value['jalur_masuk']; ?>" name="jalur_masuk" value class="form-control" placeholder="Nama Jalur Masuk" required>
                </div>
                <div class="form-group">
                    <label>Kuota</label>
                    <input type="text" value="<?= $value['kuota']; ?>" name="kuota" class="form-control" placeholder="Kuota" required>
                </div>
        </div>
        <div class="modal-footer justify-content-between">
            <button type="submit" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="delete<?= $value['id_jalur_masuk']; ?>">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
        Apakah anda yakin ingin menghapus jalur masuk <b><?= $value['jalur_masuk']; ?></b>?
        </div>
        <div class="modal-footer justify-content-between">
            <button type="submit" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
