                ...
                <tbody>
                    <?php
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-flat btn-warning btn-xs" data-toggle="modal" data-target="#edit<?= $value['id_user']; ?>">
                                    <i class="fas fa-edit"></i>
                                </button>

                                <button class="btn btn-flat btn-danger btn-xs" data-toggle="modal" data-target="#delete<?= $value['id_user']; ?>">
...
<div class="modal fade" id="add">
    <div class="modal-dialog">
        ...
        <!-- KARENA UPLOAD FILE YAITU FOTO JADI FORM_OPEN_MULTIPART -->
        <?php echo form_open_multipart('user/insertData'); ?>
        <div class="modal-body">
                <div class="form-group">
                    <label>Nama User</label>
                    <input type="text" name="nama_user1" class="form-control" placeholder="Nama User" required>
                </div>
...
<div class="modal fade" id="edit<?= $value['id_user']; ?>">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
                <div class="form-group">
                    <label>Nama User</label>
                    <input type="text" name="nama_user1" value="<?= $value['nama_user']; ?>" class="form-control" placeholder="Nama User" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <br>
                    <img src="<?= base_url('foto/' . $value['foto']); ?>" width="250px" height="250px" alt="">
                </div>
        </div>
        <div class="modal-footer justify-content-between">
            <button type="submit" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
