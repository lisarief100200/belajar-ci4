                ...
                <tbody>
                    <?php
                        ...
                        <tr>
                            ...
                            <td><?= $value['ket'];  ?></td>
                            <td>
                                <img src="<?= base_url('assets/' . $value['baner']); ?>" alt="" width="350px" height="350px">
                            </td>
                            <td>
...
<div class="modal fade" id="add">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label>File Baner (Size maksimal 1024Kb)</label>
                <input type="file" id="preview_gambar" name="baner" class="form-control" placeholder="File Baner" accept="image/*" required>
            </div>

            <div class="form-group">
                <label>Preview Baner</label><br>
                <img id="gambar_load" width="350px" height="350px">
            </div>
        </div>
...
<div class="modal fade" id="edit<?= $value['id_baner']; ?>">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <div class="form-group">
                <label>Keterangan</label>
                <input type="text" value="<?= $value['ket']; ?>" name="ket" class="form-control" placeholder="Keterangan" required>
            </div>

            <div class="form-group">
                <label>Ganti Baner Baner (Size maksimal 1024Kb)</label>
                <input type="file" id="preview_gambar" name="baner" class="form-control" placeholder="File Baner">
            </div>

            <div class="form-group">
                <label>Preview Baner</label><br>
                <img id="gambar_load" src="<?= base_url('assets/' . $value['baner']); ?>" width="350px" height="350px">
            </div>
        </div>
        <div class="modal-footer justify-content-between">
            <button type="submit" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="delete<?= $value['id_baner']; ?>">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
        Apakah anda yakin ingin menghapus baner <b><?= $value['baner']; ?></b>?
        </div>
        <div class="modal-footer justify-content-between">
            <button type="submit" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
