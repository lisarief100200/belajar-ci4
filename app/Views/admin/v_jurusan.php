                ...
                <tbody>
                    <?php
                        ...
                        <tr>
                            ...
                            <td><?= $value['jurusan'];  ?></td>
                            <td>
                                <button class="btn btn-flat btn-warning btn-xs" data-toggle="modal" data-target="#edit<?= $value['id_jurusan']; ?>">
                                    <i class="fas fa-edit"></i>
                                </button>

                                <button class="btn btn-flat btn-danger btn-xs" data-toggle="modal" data-target="#delete<?= $value['id_jurusan']; ?>">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
                <div class="form-group">
                    <label>Jurusan</label>
                    <input type="text" name="jurusan1" class="form-control" placeholder="Jurusan" required>
                </div>
        </div>
...
<div class="modal fade" id="edit<?= $value['id_jurusan']; ?>">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
                <div class="form-group">
                    <label>Jurusan</label>
                    <input type="text" name="jurusan1" value="<?= $value['jurusan']; ?>" class="form-control" placeholder="Jurusan" required>
                </div>
        </div>
        <div class="modal-footer justify-content-between">
            <button type="submit" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="delete<?= $value['id_jurusan']; ?>">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
        Apakah anda yakin ingin menghapus jurusan <b><?= $value['jurusan']; ?></b>?
        </div>
        <div class="modal-footer justify-content-between">
            <button type="submit" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
