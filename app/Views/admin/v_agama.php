                ...
                <tbody>
                    <?php
                        ...
                        <tr>
                            ...
                            <td><?= $value['agama'];  ?></td>
                            <td>
                                <button class="btn btn-flat btn-warning btn-xs" data-toggle="modal" data-target="#edit<?= $value['id_agama']; ?>">
                                    <i class="fas fa-edit"></i>
                                </button>

                                <button class="btn btn-flat btn-danger btn-xs" data-toggle="modal" data-target="#delete<?= $value['id_agama']; ?>">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
                <div class="form-group">
                    <label>Agama</label>
                    <input type="text" name="agama1" class="form-control" placeholder="Agama" required>
                </div>
        </div>
...
<div class="modal fade" id="edit<?= $value['id_agama']; ?>">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
                <div class="form-group">
                    <label>Agama</label>
                    <input type="text" name="agama1" value="<?= $value['agama']; ?>" class="form-control" placeholder="Agama" required>
                </div>
        </div>
        <div class="modal-footer justify-content-between">
            <button type="submit" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="delete<?= $value['id_agama']; ?>">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
        Apakah anda yakin ingin menghapus agama <b><?= $value['agama']; ?></b>?
        </div>
        <div class="modal-footer justify-content-between">
            <button type="submit" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
