                ...
                <tbody>
                    <?php
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-flat btn-warning btn-xs" data-toggle="modal" data-target="#edit<?= $value['id_penghasilan']; ?>">
                                    <i class="fas fa-edit"></i>
                                </button>

                                <button class="btn btn-flat btn-danger btn-xs" data-toggle="modal" data-target="#delete<?= $value['id_penghasilan']; ?>">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="penghasilan1" class="form-control" placeholder="Penghasilan" required>
                </div>
        </div>
...
<div class="modal fade" id="edit<?= $value['id_penghasilan']; ?>">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
                <div class="form-group">
                    <label>Penghasilan</label>
                    <input type="text" name="penghasilan1" value="<?= $value['penghasilan']; ?>" class="form-control" placeholder="Penghasilan" required>
                </div>
        </div>
        <div class="modal-footer justify-content-between">
            <button type="submit" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="delete<?= $value['id_penghasilan']; ?>">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
        Apakah anda yakin ingin menghapus penghasilan <b><?= $value['penghasilan']; ?></b>?
        </div>
        <div class="modal-footer justify-content-between">
            <button type="submit" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
